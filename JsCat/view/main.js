...
function showAllCat() {
    ...
    for (let i = 0; i < productInStoreCat.length; i++) {
        ...
        <table>
            <tr>
                <th><img style="width: 250px; height: 250px" src="${productInStoreCat[i].img}"></th>
            </tr>
            <tr>
...
function showFormEditCat(index) {
    ...
    <center>
        <table style="border: 2px solid">
            <tr>
                <td>Ảnh:</td>
                <td><input value="${productInStoreCat[index].img}" type="text" id="img4"></td>
            </tr>
            <tr>
                <td>Tên:</td>
                <td><input value="${productInStoreCat[index].name}" type="text" id="name4"></td>
            </tr>
            <tr>
                <td>Giá:</td>
                <td><input value="${productInStoreCat[index].price}" type="text" id="price4"></td>
            </tr>
            <tr>
...
function searchCat() {
    ...
    for (let i = 0; i < productOfStore.length; i++) {
        str += `
            <table>
                <tr>
                    <td><img style="width: 250px; height: 250px" src="${productOfStore[i].img}"></td>
                </tr>
                <tr>
