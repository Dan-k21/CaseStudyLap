...
function showAllDog() {
    ...
    for (let i = 0; i < productInStore.length; i++) {
        str += `
            <table>
                <tr>
                    <th><img style="width: 250px; height: 250px" src="${productInStore[i].img}" alt=""></th>
                </tr>
                <tr>
...
function showFormEditDog(index) {
    ...
    <center>
        <table style="border: 2px solid">
            <tr>
                <td>Ảnh:</td>
                <td><input value="${productInStore[index].img}}" type="text" id="img2"></td>
            </tr>
            <tr>
                <td>Tên:</td>
                <td><input value="${productInStore[index].name}" type="text" id="name2"></td>
            </tr>
            <tr>
                <td>Giá:</td>
                <td><input value="${productInStore[index].price}" type="text" id="price2"></td>
            </tr>
            <tr>
